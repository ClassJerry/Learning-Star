...
public class MusicForth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_forth);
        play = (Button)findViewById(R.id.play);
        pause = (Button)findViewById(R.id.pause);
        stop = (Button)findViewById(R.id.stop);
        play=(Button) findViewById(R.id.play);
        mediaPlayer=MediaPlayer.create(MusicForth.this, R.raw.qiyueshang);
...
//        }
    ...
    private void play(){
        try{
            mediaPlayer.reset();
            mediaPlayer=MediaPlayer.create(MusicForth.this, R.raw.qiyueshang);//重新设置要播放的音频
