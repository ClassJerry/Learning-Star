...
public class MusicThird extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_third);
        play = (Button)findViewById(R.id.play);
        pause = (Button)findViewById(R.id.pause);
        stop = (Button)findViewById(R.id.stop);
        play=(Button) findViewById(R.id.play);
        mediaPlayer=MediaPlayer.create(MusicThird.this, R.raw.lirenchou);
...
//        }
    ...
    private void play(){
        try{
            mediaPlayer.reset();
            mediaPlayer=MediaPlayer.create(MusicThird.this, R.raw.lirenchou);//重新设置要播放的音频
