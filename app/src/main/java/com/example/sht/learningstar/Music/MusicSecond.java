package com.example.sht.learningstar.Music;
...
public class MusicSecond extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_second);
        play = (Button)findViewById(R.id.play);
        pause = (Button)findViewById(R.id.pause);
        stop = (Button)findViewById(R.id.stop);
        play=(Button) findViewById(R.id.play);
        mediaPlayer=MediaPlayer.create(MusicSecond.this, R.raw.daojiangxin);
...
//        }
    ...
    private void play(){
        try{
            mediaPlayer.reset();
            mediaPlayer=MediaPlayer.create(MusicSecond.this, R.raw.daojiangxin);//重新设置要播放的音频
